...
## 本周总结
### 工作方面
1. 整理结算。整理了多份结算，了解了结算的文件结构。包括简单的没有变更的结算和较为复杂的存在线上、线下变更的结算。
2. 整理中期请款资料。了解了请款的文件结构，了解请款明细的制作方式。
3. 同晖项目投标公司入库资料整理，和需要入库的公司人员沟通，整理入库所需资料。
### 学习
1. 购买了建筑、结构识图课程，目前学习进度：建筑总图识图、建筑平面图。
### 下周代办
1. 跟着同事继续做结算
2. 找同事拿招标文件学习
3. 参与线下课 计量软件培训
